      ...
      <div class="search-section">
        <el-form :inline="true" :model="form" class="query-form">
          <el-form-item label="股票代码">
            <el-input v-model="form.tsCode" placeholder="可选，例：600000.SH" style="width: 200px" />
          </el-form-item>
 ...
 * 组件名称：IrmQaShView
 * 功能：
 * - 查询并展示 `/django/api/tasks/irm-qa-sh/` 的上证 e 互动董秘问答数据
...
import { fetchIrmQaSh, type IrmQaItem } from '@/services/irmQaApi'
